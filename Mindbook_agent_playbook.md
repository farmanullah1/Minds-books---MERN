...
# REMAINING PROMPTS (PROMPT-04 through PROMPT-20)

*Each of the following prompts follows the same extreme-detail pattern established above. The agent MUST implement each sub-prompt fully before advancing.*

---

## PROMPT-04 — Messaging System
**Sub-prompts:** 04.A Backend Models → 04.B Socket.IO Setup → 04.C Chat List UI → 04.D Chat Window → 04.E Message Input → 04.F Voice/Video Calls → 04.G Group Chats → 04.H Advanced Features
*(See PROMPT-34 in v6.0 for the complete spec — implement every detail with the same code-first, CSS-complete, animation-included approach shown above)*

## PROMPT-05 — Video Hub + YouTube Integration
*(See PROMPT-49 in v6.0 for complete spec — include SourceBadge on every video, YouTube API service, unified feed, dual player pages)*

## PROMPT-06 — News Feed
*(See PROMPT-06 in v6.0 for complete spec — PostCard, Reactions, Comments, PostComposer, three-column layout)*

## PROMPT-07 — Groups, Friends, Settings
*(See PROMPT-36, PROMPT-37, PROMPT-35 in v6.0)*

## PROMPT-08 — Portfolio & Extra Pages
*(See PROMPT-08 in v6.0 — developer links, About page, Why I Created, Meet the Creator)*

## PROMPT-09 — Stories System
*(Full story tray, viewer, creation, reactions, replies — see PROMPT-06 in v6.0)*

## PROMPT-10 — Admin System
*(Full admin dashboard — see Section A in v6.0)*

## PROMPT-11 — AI MindBot
*(See PROMPT-33 in v6.0)*

## PROMPT-12 — Notifications
*(See PROMPT-38 in v6.0)*

## PROMPT-13 — Search & Explore
*(See PROMPT-39 + PROMPT-47 in v6.0)*

## PROMPT-14 — Marketplace + Events
*(See PROMPT-40 + PROMPT-41 in v6.0)*

## PROMPT-15 — LinkedIn Features
*(See PROMPT-30 in v6.0)*

## PROMPT-16 — Reels
*(See PROMPT-46 in v6.0)*

## PROMPT-17 — Live Streaming + Audio Rooms
*(See PROMPT-43 + PROMPT-52 in v6.0)*

## PROMPT-18 — Creator Studio + Analytics
*(See PROMPT-51 + PROMPT-59 in v6.0)*

## PROMPT-19 — Wallet + Economy
*(See PROMPT-24 + D sections in v6.0)*

## PROMPT-20 — Final QA + Portfolio Polish
*(See PROMPT-60 in v6.0 — seed data, landing page, Lighthouse audit, developer links everywhere)*
